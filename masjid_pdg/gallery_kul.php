...
<html lang="en">
  ...
  <head>
      ...
      <div>
          <?php
            ...
            $sqlname=mysqli_query($conn,"SELECT name FROM restaurant where id='$id'");
            while ($row = mysqli_fetch_array($sqlname))
            {
              $nama=$row['name'];
            ?>
          <title><?php echo "$nama"?> Padang Culinary</title>
          <?php }?>
        </div>
  ...
  <body onload="init();detailculinary('<?php echo $_GET["idgallery"] ?>');" > 
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section id="container" >
      <header class="header black-bg">
        <a class="logo" style="font-family: Arial"><i class="fa fa-bars tooltips" style="color: white" data-placement="right" data-original-title="Toggle Navigation"></i>&nbsp&nbsp<b>WEB</b><b>GIS •</b> Detail Culinary</a>
                ...
                <div class="col-sm-6"> 
                  <section class="panel"> <!-- detail information -->
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize; text-align:center;"><b> &nbsp Culinary Information</b></h2>
                    </header>
                      <div class="text-center">
                        <?php
                          ...
                          $querysearch ="SELECT id_kuliner AS id, count(*) as review, AVG(rating) AS rating FROM review where id_kuliner='$id'";
                      ...
                      <?php
                        ...
                        $id=$_GET["idgallery"];
                        $sql = "SELECT culinary_place.name, culinary_place.id, culinary_place.address, culinary_place.open, culinary_place.close from culinary_place where culinary_place.id= '$id' ";
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            <?php
                                  require 'connect.php';
                                  $id=$_GET["idgallery"];
                                  $sqlcontact=mysqli_query($conn,"SELECT cp FROM culinary_place where id='$id'");
                                ...
                                <?php
                                  ...
                                  if (strpos($id,"RM") !== false) { 
                                    ...
                                    while($baris = mysqli_fetch_array($hasil))
                                    {
                                      ...
                                      {
                                          echo "<a href='foto/culinary/foto.jpg'><img src='foto/culinary/foto.jpg' ></a>";
                                      }
                                      else
                                      {
                                      echo "<a href='foto/culinary/".$baris['gallery_culinary']."'><img src='foto/culinary/".$baris['gallery_culinary']."'></a>";
                                      }
                                    }
                                  }
                                ?> <br>                                    
                      ...
                      <section class="panel">
                        <div class="panel-body">
                          <header class="panel-heading">
                            ...
                            <form method="POST" action="insert_comment_kul.php">
