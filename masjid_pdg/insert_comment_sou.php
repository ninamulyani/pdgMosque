<?php 
    ...
    if($_POST['submit']){
        ...
        $sql = "INSERT into review(id_review,name,comment,tanggal,id_souvenir,rating) values('$id_review','$nama','$comment',CURRENT_TIMESTAMP,'$id','$rating')";
		...
		echo "<script>
			eval(\"parent.location='gallery_sou.php?idgallery=$id'\");	
            </script>";
?>
