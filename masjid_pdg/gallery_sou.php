...
<html lang="en">
  ...
  <head>
      ...
      <div>
          <?php
            ...
            $sqlname=mysqli_query($conn,"SELECT name FROM souvenir where id='$id'");
            while ($row = mysqli_fetch_array($sqlname))
            {
              $nama=$row['name'];
            ?>
          <title><?php echo "$nama"?> Padang Souvenir</title>
          <?php }?>
        </div>
  ...
  <body onload="init();detailoleh('<?php echo $_GET["idgallery"] ?>');" > 
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section id="container" >
      <header class="header black-bg">
        <a class="logo" style="font-family: Arial"><i class="fa fa-bars tooltips" style="color: white" data-placement="right" data-original-title="Toggle Navigation"></i>&nbsp&nbsp<b>WEB</b><b>GIS •</b> Detail Souvenir </a>
        ...
        <section class="wrapper site-min-height">
          <div class="row">
            <div class="col-lg-12 main-chart"> 
                <div class="col-sm-6"> 
                  <section class="panel"> <!-- detail information -->
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize; text-align:center;"><b> &nbsp Souvenir Information</b></h2>
                    </header>
                      <div class="text-center">
                        <?php
                          ...
                          $querysearch ="SELECT id_souvenir AS id, count(*) as review, AVG(rating) AS rating FROM review where id_souvenir='$id'";
                          ...
                          while($row = mysqli_fetch_array($result))
                          {
                            ...
                            $dataarray[]=array('id'=>$id_sou, 'rating'=>$rating,'review'=>$review);
                          }
                      ...
                      <?php
                        ...
                        $id=$_GET["idgallery"];
                        $sql = "SELECT souvenir.id, souvenir.address, souvenir.name, souvenir.owner, souvenir.cp, status.status as status, souvenir_type.name as type_name
                        FROM souvenir
                        LEFT JOIN status ON souvenir.id_status = status.id
                        LEFT JOIN souvenir_type ON souvenir.id_souvenir_type = souvenir_type.id WHERE souvenir.id = '$id' ";
                          ...
                          <div class="form-group">
                            <table class="table" id='soudet'>
                              <tbody id="bodi" style='vertical-align:top;'>
                                ...
                                <tr><td><b>Status</b></td><td>:</td><td><?= $rows['status'] ?></td></tr>
                                <tr><td><b>Type</b></td><td>:</td><td><?= $rows['type_name'] ?></td></tr>
                                <tr><td><b>Owner</b></td><td>:</td><td><?= $rows['owner'] ?></td></tr>
                              </tbody>
                            </table>   
                          </div>
                        </div>
                  ...
                  <section class="panel">
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize; text-align:center;"><b>&nbsp More Information</b></h2>
                    </header>
                        <div class="panel-body">
                          <div class="box-body">
                            <div class="form-group">
                              <?php
                                  require 'connect.php';
                                  $id=$_GET["idgallery"];
                                  $sqlcontact=mysqli_query($conn,"SELECT cp FROM souvenir where id='$id'");
                            ...
                            <div class="form-group">
                              <table class="table">
                                <thead><th colspan='2'>Date</th><th class="centered">Info</th></thead>
                                  <?php  
                                  while ($rows = mysqli_fetch_array($result)) 
                                      ...
                                      echo "<tr><td colspan='2'>$tgl</td><td>$info</td><td></td></tr>";
                                      }
                                  ?>               
                              </table>
                            </div>
                ...
                <div class="col-sm-6">
                  <div class="row">
                    <div class="col-sm-12"> <!-- gallery souvenir -->
                      <section class="panel">
                        <div class="panel-body">
                        <header class="panel-heading">
                                ...
                                <?php
                                  ...
                                  if (strpos($id,"SO") !== false) { 
                                    ...
                                    while($baris = mysqli_fetch_array($hasil))
                                    {
                                      ...
                                      {
                                      echo "<a href='foto/souvenir/".$baris['gallery_souvenir']."'><img src='foto/souvenir/".$baris['gallery_souvenir']."'></a>";
                                      }
                                    }
                                  }
                                ?> <br>                                    
                    ...
                    <div class="col-sm-12"> <!-- RATING & REVIEW -->
                      <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <form method="POST" action="insert_comment_sou.php">
