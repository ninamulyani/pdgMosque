<?php 
    ...
    if($_POST['submit']){
        ...
        $sql = "INSERT into review(id_review,name,comment,tanggal,id_ow,rating) values('$id_review','$nama','$comment',CURRENT_TIMESTAMP,'$id','$rating')";
		...
		echo "<script>
			eval(\"parent.location='gallery_tour.php?idgallery=$id'\");	
            </script>";
?>
