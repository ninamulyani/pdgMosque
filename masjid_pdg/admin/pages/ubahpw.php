 <div class="col-sm-12"> <!-- menampilkan form add event-->
        ...
        <button type="submit" class="btn btn-primary pull-right" onclick="show1()" style="background-color: #26a69a; border: 1px solid #e7e7e7;">Change <i class="fa fa-floppy-o"></i></button>  
</form>
