  <div class="col-sm-6"> <!-- menampilkan peta-->
    <section class="panel">
      <header class="panel-heading">
        <h3>
            ...
            <button class="btn btn-default my-btn" id="btnlatlng" type="button" title="Geocode"><i class="fa fa-search" style="color: white;"></i></button>
            <button class="btn btn-default my-btn" id="delete-button" type="button" title="Remove shape"><i class="fa fa-trash" style="color: white;"></i></button> 
        </h3>
      </header>
    ...
    <section class="panel">
      <div class="panel-body">
        <a class="btn btn-compose"> <b>Update Worship Place's Information</b> </a>
          <div class="box-body">
              ...
              ?>
                <form role="form" action="act/updatemesadmin.php" enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="luas_tanah" value="<?php echo $data['land_size'] ?>" >
                  </div>
                  <div class="form-group">
                    <label for="luas_bangunan">Building Size</label>
                    <input type="number" class="form-control" name="luas_bangunan" value="<?php echo $data['building_size'] ?>" >
                  </div>
                  <div class="form-group">
                    <label for="luas_area_parkir">Park Area Size</label>
                    <input type="number" class="form-control" name="luas_area_parkir" value="<?php echo $data['park_area_size'] ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="thn_berdiri" value="<?php echo $data['est'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="thn_renovasi_terakhir">Last Renovation</label>
                    <input type="number" class="form-control" name="thn_renovasi_terakhir" value="<?php echo $data['last_renovation'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="jml_imam">Imam</label>
                    <input type="number" class="form-control" name="jml_imam" value="<?php echo $data['imam'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="jml_jamaah">Jamaah</label>
                    <input type="number" class="form-control" name="jml_jamaah" value="<?php echo $data['jamaah'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="jml_remaja">Teenager</label>
                    <input type="number" class="form-control" name="jml_remaja" value="<?php echo $data['teenager'] ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary pull-right" style="border: 1px solid #e7e7e7;background-color: #26a69a;">Update <i class="fa fa-floppy-o"></i></button>
                </form>
            </div>
          </div>
      </div>
