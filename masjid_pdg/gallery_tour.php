...
<html lang="en">
  ...
  <head>
      ...
      <div>
          <?php
            ...
            $sqlname=mysqli_query($conn,"SELECT name FROM tourism where id='$id'");
            while ($row = mysqli_fetch_array($sqlname))
            {
              $nama=$row['name'];
            ?>
          <title><?php echo "$nama"?> Padang Tourism</title>
          <?php }?>
        </div>
  ...
  <body onload="init();detailow('<?php echo $_GET["idgallery"] ?>');" >
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <section id="container" >
      <header class="header black-bg">
        <a class="logo" style="font-family: Arial"><i class="fa fa-bars tooltips" style="color: white" data-placement="right" data-original-title="Toggle Navigation"></i>&nbsp&nbsp<b>WEB</b><b>GIS •</b> Detail Tourism </a>
        ...
        <section class="wrapper site-min-height">
          <div class="row">
            <div class="col-lg-12 main-chart"> 
                <div class="col-sm-6"> 
                  <section class="panel"> <!-- information -->
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize; text-align:center;"><b> &nbsp Tourism Information</b></h2>
                    </header>   
                    <div class="text-center">
                      ...
                      <?php
                        ...
                        $id=$_GET["idgallery"];
                        $sql = "SELECT tourism.id, tourism.name, tourism.address, tourism.open, tourism.close, tourism.ticket, tourism_type.name as tourism_type, st_x(st_centroid(tourism.geom)) as lon, st_y(st_centroid(tourism.geom)) as lat from tourism left join tourism_type on tourism_type.id=tourism.id_type where tourism.id ='$id' ";
                          ...
                          <div class="form-group">
                            <table class="table">
                              <tbody id="bodi" style='vertical-align:top;'>
                                ...
                                <tr><td><b>Ticket</b></td><td>:</td><td><?= $rows['ticket'] ?></td></tr>
                                <tr><td><b>Type</b></td><td>:</td><td><?= $rows['tourism_type'] ?></td></tr>
                              </tbody>
                            </table>   
                          </div>
                          <div class="form-group">
                              <?php
                                  require 'connect.php';
                                  $id=$_GET["idgallery"];
                                  $sqlcontact=mysqli_query($conn,"SELECT cp FROM tourism where id='$id'");
                  ...
                  <section class="panel" > <!-- Detail Fasilitas -->
                    ...
                    <?php
                      require 'connect.php';
                        ...
                        $sql1 = "SELECT facility_tourism.id, facility_tourism.name 
                        FROM facility_tourism left join detail_facility_tourism on detail_facility_tourism.id_facility = facility_tourism.id left join tourism on tourism.id = detail_facility_tourism.id_tourism where tourism.id = '".$id."'  ";     
                  ...
                  <section class="panel" style="display:none;"> <!-- Detail Event -->
                    <header class="panel-heading">
                      <h2 class="box-title" style="text-transform:capitalize; text-align:center;"><b>&nbsp Upcoming Event</b></h2>
                        <div>                        
                        </div>
                    </header>
                    ...
                    <?php
                        ...
                        $sql2 = "SELECT event_tourism.id_event, event_tourism.tourism_id, event_tourism.nama_event, 
                                      ...
                                      id="foto-event">
                                        ...
                                        <?php
                                          ...
                                          while($baris = mysqli_fetch_array($hasil))
                                          {
                                            ...
                                            $xx++;
                                          ?>
                                          <image src="../foto/event_tourism/<?php echo $nilai; ?>" style="width:10%;">
                                       
                                          <?php
                                              }
                                              if($xx==0){
                                          ?>
                                          <image src="../foto/event_tourism/mugen.jpg" style="width:10%;">
                                          <?php
                                              }
                                              echo "$nilai";
                                        ?>                    
                ...
                <div class="col-sm-6">
                  <div class="row">
                    <div class="col-sm-12"> <!-- gallery tourism -->
                      <section class="panel">
                        <div class="panel-body">
                          <header>
                                ...
                                <?php
                                  ...
                                  if (strpos($id,"TM") !== false) {  
                                    ...
                                    while($baris = mysqli_fetch_array($hasil))
                                    {
                                      ...
                                      {
                                          echo "<a href='foto/tourism/foto.jpg'><img src='foto/tourism/foto.jpg' ></a>";
                                      }
                                      else
                                      {
                                      echo "<a href='foto/tourism/".$baris['gallery_tourism']."'><img src='foto/tourism/".$baris['gallery_tourism']."'></a>";
                                      }
                                    }
                                  }
                                ?> <br>                                    
                      ...
                      <section class="panel">
                        <div class="panel-body">
                          <header>
                            ...
                            <form method="POST" action="insert_comment_tour.php">
